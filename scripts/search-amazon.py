#!/usr/bin/env python3
"""
ma-pay-hub/scripts/search-amazon.py
Amazon Jobs scraper — MA edition.

Strategy: Query amazon.jobs/en/search.json for MA locations.
...
LOG_FILE  = os.path.expanduser("~/ma-pay-hub/scripts/amazon.log")
LOCK_FILE = os.path.expanduser("~/ma-pay-hub/scripts/.amazon.lock")
...
QUERY_LOCATIONS = ['Boston, Massachusetts, USA', 'Cambridge, Massachusetts, USA', 'Virtual Location - Massachusetts, USA']

REGION_TERMS = ['massachusetts', 'boston', 'cambridge', 'worcester', 'springfield', 'lowell', 'somerville', ', ma']

CITY_MAP = {'boston': 'Boston, MA', 'cambridge': 'Cambridge, MA', 'worcester': 'Worcester, MA'}
...
def main():
    ...
    log("=== Amazon Jobs MA scraper started ===")
    ...
    log(f"=== Amazon MA scraper complete: {total_found} new jobs ===")
    return 0
