#!/usr/bin/env python3
# ma-pay-hub/scripts/search-successfactors.py
# MA Pay Equity Act — salary range required on request (eff. Jul 1 2018)

LOG_FILE  = "/Users/clawii/ma-pay-hub/scripts/successfactors.log"
LOCK_FILE = "/Users/clawii/ma-pay-hub/scripts/.successfactors.lock"
...
SEED_PORTALS = load_successfactors_seeds('ma')
REGION_TERMS    = ['boston', 'cambridge', 'waltham', 'lexington', 'bedford', 'woburn', 'framingham', 'marlborough', 'lowell', 'worcester', 'andover', 'wilmington', 'burlington', 'westborough', 'somerville', 'newton', 'natick', ', ma,', ', ma ', 'massachusetts']
NON_REGION_TERMS = []
CITY_MAP        = {'boston': 'Boston, MA', 'cambridge': 'Cambridge, MA', 'waltham': 'Waltham, MA', 'lexington': 'Lexington, MA', 'bedford': 'Bedford, MA', 'woburn': 'Woburn, MA', 'framingham': 'Framingham, MA', 'marlborough': 'Marlborough, MA', 'lowell': 'Lowell, MA', 'worcester': 'Worcester, MA', 'andover': 'Andover, MA', 'burlington': 'Burlington, MA'}
DEFAULT_LOCATION = 'Massachusetts, MA'
SALARY_MIN      = 30000
SALARY_MAX      = 1000000
